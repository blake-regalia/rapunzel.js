...
* class:
**/
const local = classer.logger('rapunzel');
module.exports = function(h_init_productions, a_init_steps=[]) {
	/**
	* private:
	**/
	...
	const produce_string = (h_options, h_forward) => {
		...
		//
		let add = Object.assign(function(s_chunk, z_merge_delim=false, b_ignore_close=false) {
